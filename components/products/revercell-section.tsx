    ...
    >
      ...
      <div className="mx-auto w-full max-w-[1440px] px-6 pt-4 pb-10 md:px-10 md:pb-16">
        ...
        <div className="mx-auto flex max-w-3xl flex-col items-center gap-6 text-center md:gap-8">
          <p className="text-[20px] font-bold leading-[1.4] text-[#3E454B] md:text-[28px] md:leading-[40px]">
            리버셀 주사 (Revercell)
          </p>
          <div className="h-px w-16 bg-primary" aria-hidden="true" />
          <h3 className="text-balance text-[22px] font-medium leading-[1.4] text-primary md:text-[30px] md:leading-[48px]">
            줄기세포의 재생 및 분화 메커니즘
          </h3>
          <p className="text-pretty text-[14px] leading-[1.9] text-foreground/80 md:text-[15px] md:leading-[2]">
