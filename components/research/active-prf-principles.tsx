...
const tableRows: TableRow[] = [
  ...
  },
  {
    label: "성장인자 유지",
    prp: "1시간",
    activePrp: "7일 이상 활성화 세포 치료",
    activePrf: "10~14일 지속적으로 재생 치료",
  },
  {
    label: "성장인자 방출",
    prp: "자연 방출(느림)",
    activePrp: "즉각 방출(빠르고 강력)",
    activePrf: "즉각작이고 강함(고농도)",
    highlight: "both",
  },
  {
    label: "통증",
    prp: "아주 심함(ph4.5 강한 산성)",
    activePrp: "없음",
    activePrf: "없음",
  },
  {
    label: "치료 효과",
    prp: "서서히 효과 발현",
    activePrp: "빠른 조직 재생, 형혈 효과 우수",
    activePrf: "빠른 조직 재생, 형혈 효과 우수",
    highlight: "both",
  },
  {
    label: "섬유소",
  ...
  },
  {
    label: "성장인자 활상화",
    prp: "미미",
    activePrp: "강력한 세포 활상화",
    activePrf: "강력안 세포 활상화",
    highlight: "both",
  },
  {
    label: "섬유소 네트워크",
      ...
      <div className="mx-auto flex max-w-[1280px] flex-col gap-8 px-4 sm:px-6 sm:gap-10 md:gap-16 md:px-20">
        ...
        <div className="flex flex-col gap-4 sm:gap-6 md:gap-10">
          ...
          <p className="text-[14px] font-normal leading-[1.6] text-[#3E454B] sm:text-[15px] md:text-[20px] md:leading-[30px]">
            현재 활성 PRF(Active PRF)에 의한 재생 치료 결과는 뛰어난 생체
            적합성과 재생 효율로 인해 임상 현장에서 폭넓게 활용되고 있습니다.
            하지만 임상적 치료 수단으로서 이 기술을 온전히 활용하기 위해서는,
            기존 재생 방식(PRP 등)과의 근본적인 메커니즘 차이를 알고 이를
            정밀하게 따져보는 전문적 식견이 필요합니다.
            <br />
            Active PRF를 다루는 임상 전문가는 혈액의 응고 기전과 피브린
            네트워크(Fibrin Network) 형성 원리를 충분히 이해하여, 성장인자의
            방출 주기와 세포 증식에 영향을 미치는 생물학적 요인을 최적화해야
            합니다. 특히 저항과 리액턴스를 이해하듯, 섬유소의 밀도와 성장인자의
            서방형 방출(Sustained Release) 개념을 이해하는 것이 치료의 성패를
            좌우합니다.
          </p>
        </div>
