...
export const translations = {
  ...
  products: {
    ...
    quantumRestSectionTitle: {
      ko: "양자산소",
      en: "Quantum Oxygen",
    },
    quantumRestTitle: {
      ko: "단순한 휴식을 넘어, 세포의 잠을 깨우는 과학",
      en: "Beyond Simple Rest: The Science of Awakening Dormant Cells",
    },
    quantumRestDesc1: {
      ko: "기존의 단순한 고압 산소 공급 방식에서 한 걸음 더 나아갔습니다. 양자 산소 챔버는 독자적인 양자 파동 기술을 결합하여, 산소 입자가 세포막을 보다 효율적이고 깊숙이 통과할 수 있도록 돕습니다. 이를 통해 일반적인 산소 테라피로는 도달하기 어려웠던 체내 깊은 곳까지 풍부한 에너지를 전달합니다.",
      en: "Going beyond conventional high-pressure oxygen delivery, the quantum oxygen chamber combines proprietary quantum wave technology to help oxygen particles pass through cell membranes more efficiently and deeply. This delivers abundant energy to deeper areas of the body that ordinary oxygen therapy struggles to reach.",
    },
    quantumRestDesc2: {
      ko: "세포 내부의 에너지 공장인 미토콘드리아를 양자 에너지가 직접 자극합니다. 세포 공명 현상을 통해 정체되어 있던 에너지 대사를 정상화함으로써, 만성적인 무기력증을 해소하고 몸 전체의 활력을 즉각적으로 회복시켜 드립니다.",
      en: "Quantum energy directly stimulates mitochondria, the energy factories inside cells. Through cellular resonance, it helps normalize stagnant energy metabolism, easing chronic fatigue and restoring vitality throughout the body.",
    },
    quantumRestDesc3: {
      ko: "눈에 보이지 않는 미세한 양자 진동이 신체 구석구석에 전달됩니다. 이 강력한 진동은 체내 깊숙이 쌓여 배출되지 못했던 노폐물과 독소의 배출을 촉진하여, 몸의 무거움을 근본적으로 해결하고 한결 가벼워진 신체 컨디션을 선사합니다.",
      en: "Subtle, invisible quantum vibrations are delivered throughout the body. These powerful vibrations promote the release of deeply accumulated waste and toxins, addressing bodily heaviness at its source and supporting a lighter physical condition.",
    },
